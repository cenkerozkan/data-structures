...
class stackADT{
    public:
        virtual void initialize_stack() = 0;   // Initializes the stack into an empty state.
        virtual bool is_empty() = 0; // Returns true if empty.
        virtual bool is_full() = 0; // Returns true if full.
        virtual void push(T &_param) = 0; // Adds a new element on top of the stack.
        virtual T top() = 0; // Returns the top value of the stack
